...
get_page(Pager* pager, uint32_t page_num)
{
  ...
  if (pager->pages[page_num] == NULL) {
    ...
    // We might save save a partial page at the end of the file
...
prepare_insert(InputBuffer* input_buffer, Statement* statement)
{
  ...
  /*strtok keeps a memory of the pointer of the first call*/
  /* that is likely not thread safe */
